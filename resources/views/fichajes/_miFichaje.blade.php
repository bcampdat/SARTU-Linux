...
<div class="bg-white p-8 rounded-2xl shadow-xl text-center space-y-6">
    ...
    <div
        ...
        data-segundos="{{ $segundosTrabajoActual }}">00:00:00</div>

    {{-- RELOJ PAUSA --}}
    <div
        id="relojPausa"
        class="text-xl font-mono font-bold text-yellow-500"
        data-segundos="{{ $segundosPausaActual }}">00:00:00</div>
    ...
    <div class="w-full bg-gray-300 rounded-full h-5 overflow-hidden">
        <div
            ...
            class="h-5 bg-sartu-rojo transition-all duration-500"></div>
    </div>
    ...
    {{-- BOTONES --}}
    <form method="POST" id="formMiFichaje" action="{{ route('fichajes.store') }}" class="flex flex-wrap gap-6 justify-center mt-6">
        @csrf
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const form = document.getElementById('formMiFichaje');
            ...
            btn.addEventListener('click', function(e) {
                ...
                navigator.geolocation.getCurrentPosition(
                    pos => {
                        ...
                        console.log("GPS OK:", latInput.value, lngInput.value);
